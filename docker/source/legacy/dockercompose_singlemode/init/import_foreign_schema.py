...
# Get the PATIENT_DB_PORT from the command-line argument
PATIENT_DB_PORT = sys.argv[1] if len(sys.argv) > 1 else "5431"
...
"""source_info = {
    ...
    "ip": host_ip,
    "port": "5432",
    "port_docker": os.environ.get("PATIENT_DB_PORT", "5431")
}"""
